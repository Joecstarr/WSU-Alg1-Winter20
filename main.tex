...
\newcommand{\pofinv}[1]{\phi^{\m1}\lrp{#1}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 3
\input{Chapters/3/Section1.tex}
\clearpage
\input{Chapters/3/Section2.tex}
\clearpage
\input{Chapters/3/Section3.tex}
\clearpage
\input{Chapters/3/Section4.tex}
\clearpage
\input{Chapters/3/Section5.tex}
\clearpage
\input{Chapters/3/Section6.tex}
\clearpage
\input{Chapters/3/Section7.tex}
\clearpage
\input{Chapters/3/Section8.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 4
\input{Chapters/4/Section1.tex}
\clearpage
\input{Chapters/4/Section2.tex}
\clearpage
\input{Chapters/4/Section3.tex}
\clearpage
\input{Chapters/4/Section4.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 5
\input{Chapters/5/Section1.tex}
\clearpage
\input{Chapters/5/Section2.tex}
\clearpage
\input{Chapters/5/Section3.tex}
\clearpage
\input{Chapters/5/Section4.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 6
\input{Chapters/6/Section1.tex}
\clearpage
\input{Chapters/6/Section2.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 7
\input{Chapters/7/chapter7.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 8
\input{Chapters/8/chapter8.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 9
\input{Chapters/9/chapter9.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Chapter 10
\input{Chapters/10/chapter10.tex}
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Compile Appendix
\input{Chapters/appendix/GeneralProofs.tex}
\clearpage
\end{document}